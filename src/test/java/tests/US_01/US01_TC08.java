...
public class US01_TC08 {
    ...
    public void test08() throws IOException {
        ...
        mustafaPgc.confirmPasswordKutusu.sendKeys("Asdf*789");
        ...
        //  9- Farklı password girildigini ve hata uyarisi verdigini test eder
        ReusableMethods.waitFor(2);
        String expextedPasswordErrorYazisi = "Password and Confirm-password are not same.";
        Assert.assertTrue(mustafaPgc.passwordNotSameYazisi.getText().contains(expextedPasswordErrorYazisi));

        //ReusableMethods.getScreenshot("US01_TC08 ");
        Driver.quitDriver();
    }
}
