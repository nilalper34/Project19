...
public class US007_TC008 {
    ...
    public void test008() throws IOException, InterruptedException {
        ...
        // 17-Product Brands ten NS8 ve Node Js i tiklar
        ReusableMethods.waitFor(2);
        page.bisikletBox.click();
        page.nS8Box.click();
        page.nodeJsBox.click();

        ReusableMethods.getScreenshot("Product Brands kisninda NS8 ve Node Js in ikisi ayni anda seciliyor!.. ");
        ...
        // 19-Product Successfully Published yazisini içermemeli...
        Assert.assertFalse(page.successfullyMessage.getText().contains("Product Successfully Published."),
                "Product Successfully Published. yazisini iceriyor ");
