...
public class US20_TC01 {
    ...
    public void us20_tc01 () throws InterruptedException {
        //1- Vendor https://hubcomfy.com/ adresine giderD
        ...
        //11- Vendor yorum yapanlarin kullanici bilgilerinin gorundugunu dogrular
        actions.sendKeys(Keys.PAGE_DOWN).perform();
        Assert.assertTrue(hayrullahpgc.author.isDisplayed());
