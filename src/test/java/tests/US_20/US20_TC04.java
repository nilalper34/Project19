...
public class US20_TC04 {
    hayrullahpgc hayrullahpgc = new hayrullahpgc();
    Actions actions = new Actions(Driver.getDriver());

    @Test
    public void us20_tc04 () throws InterruptedException {
        ...
        //11- Vendor yorum yapanlarin yorumlarinin tarihlerinin gorundugunu dogrular
        actions.sendKeys(Keys.PAGE_DOWN).perform();
        Assert.assertTrue(hayrullahpgc.dated.isDisplayed());
