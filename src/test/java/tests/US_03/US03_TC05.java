...
public class US03_TC05 {
    ...
    public void us03_tc05() throws InterruptedException {
        ...
        hayrullahpgc.firstName.sendKeys(faker.name().firstName());
        hayrullahpgc.lastName.sendKeys(faker.name().lastName());
        ...
        //13. Vendor  phone bilgisi girer
        actions.sendKeys(Keys.PAGE_DOWN,Keys.TAB,faker.phoneNumber().cellPhone()).perform();


        //14. Vendor  email bilgisi girer
        actions.sendKeys(Keys.TAB,faker.internet().emailAddress()).perform();

        //15. Vendor  place order'a tıklar
        actions.sendKeys(Keys.PAGE_DOWN).perform();

        ReusableMethods.jsclick(hayrullahpgc.placeOrder);
